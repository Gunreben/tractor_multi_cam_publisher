...
python3 $DIR/draw_rectified_image.py --jpeg_path $DIR/camera_images/zed_zed_node_right_raw_color.jpg --intrinsics_calibration $DIR/zed_zed_node_right_raw_color.intrinsics.yaml
...
python3 $DIR/draw_rectified_image.py --jpeg_path $DIR/camera_images/zed_zed_node_left_raw_color.jpg --intrinsics_calibration $DIR/zed_zed_node_left_raw_color.intrinsics.yaml
